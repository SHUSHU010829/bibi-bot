...
const SINK_SOURCES = ["shop_buy", "auction_bid", "wealth_tax", "transfer_out", "transfer_fee", "deposit_lock", "deposit_penalty", "stock_buy", "stock_fee", "event_host_lock", "invite_clawback", "duel_stake", "stone_appraisal", "market_buy", "market_escrow", "market_bid", "farm_plant", "farm_expand", "barter_fee", "guild_create", "guild_donate", "quest_reroll", "quest_skip"];
