...
const FLAT_REWARD_SOURCES = ["welfare", "quest_daily", "quest_weekly", "quest_event", "stock_sell", "stock_dividend", "invite_reward", "invite_welcome", "mining_sell", "work", "dungeon", "donation", "encounter", "farm_harvest", "farm_raid", "farm_sell", "boss_loot", "boss_killer", "boss_kill_bonus", "guild_create_refund", "guild_disband_payout"];
