...
const SINK_SOURCES = ["shop_buy", "auction_bid", "wealth_tax", "transfer_out", "transfer_fee", "deposit_lock", "deposit_penalty", "stock_buy", "stock_fee", "stock_tax", "stock_daytrade_tax", "stock_div_tax", "stock_insider_fee", "stock_short_margin", "event_host_lock", "event_fund_donate", "invite_clawback", "duel_stake", "stone_appraisal", "market_buy", "market_escrow", "market_bid", "bulk_escrow", "bulk_sell_buy", "listing_fee", "renew_fee", "swap_fee", "farm_plant", "farm_expand", "barter_fee", "guild_create", "guild_donate", "guild_warehouse_fee", "guild_consign_buy", "quest_reroll", "quest_skip", "steal_loss", "bounty_escrow", "bounty_place_escrow", "bounty_fine", "bail", "detective_fee", "detective_crooked", "detective_arale", "detective_catch_lose", "detective_penalty", "detective_counterrob", "revenge_pay", "gold_buy", "savings_deposit", "loan_repay"];
const PEER_SOURCES = ["transfer_in", "transfer_out", "transfer_refund", "deposit_lock", "deposit_release", "event_prize", "event_refund", "event_fund_refund", "event_fund_host_share", "auction_payout", "auction_refund", "duel_payout", "duel_refund", "market_payout", "market_refund", "bulk_payout", "bulk_refund", "bulk_sell_payout", "steal_gain", "bounty_payout", "bounty_refund", "bounty_fine_reward", "bounty_victim_compensation", "revenge_win"];
const FLAT_REWARD_SOURCES = ["welfare", "quest_daily", "quest_weekly", "quest_event", "stock_sell", "stock_dividend", "stock_short_settle", "stock_delist_settlement", "stock_raffle_prize", "stock_rebate", "invite_reward", "invite_welcome", "mining_sell", "work", "dungeon", "donation", "encounter", "farm_harvest", "farm_raid", "farm_sell", "boss_loot", "boss_killer", "boss_kill_bonus", "boss_first_strike", "boss_participation", "boss_treasure", "boss_event", "guild_create_refund", "guild_donate_refund", "guild_disband_payout", "deposit_interest", "survey", "fund_payout", "gold_sell", "gold_overflow", "savings_withdraw", "savings_interest", "loan_out", "detective_catch_win", "detective_reward"];
