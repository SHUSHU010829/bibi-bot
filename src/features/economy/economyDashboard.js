...
const PURE_MINT_SOURCES = new Set([
  ...
  "boss_loot", "boss_killer", "boss_kill_bonus", "boss_first_strike", "boss_participation", "boss_treasure",
...
const MARKET_GROUPS = {
  ...
  dungeon: ["dungeon"],
  boss: ["boss_loot", "boss_killer", "boss_kill_bonus", "boss_first_strike", "boss_participation", "boss_treasure"],
